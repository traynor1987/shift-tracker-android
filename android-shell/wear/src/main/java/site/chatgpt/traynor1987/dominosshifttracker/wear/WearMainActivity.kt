...
class WearMainActivity : Activity(), DataClient.OnDataChangedListener {
    ...
    private fun infoButton()=Button(this).apply{text="ⓘ";textSize=18f;gravity=Gravity.CENTER;includeFontPadding=false;isAllCaps=false;setPadding(0,0,0,0);setTextColor(Color.WHITE);contentDescription="Settings and About";background=GradientDrawable().apply{shape=GradientDrawable.OVAL;setColor(Color.rgb(35,35,38));setStroke(2,Color.rgb(90,170,235))};setOnClickListener{showInfo()}}
