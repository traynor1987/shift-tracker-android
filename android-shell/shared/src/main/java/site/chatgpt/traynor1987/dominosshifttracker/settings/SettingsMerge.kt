...
object SettingsMerge {
    val defaults = linkedMapOf("keep_awake" to "true", "battery_saver_display" to "true", "show_earnings" to "true",
        "haptic_geofence" to "true", "break_alert" to "true", "dim_delay" to "15000", "break_minutes" to "30", "deliveries" to "20", "hours" to "8", "main_timer" to "activity", "main_stat" to "deliveries_earnings", "break_ring" to "true", "battery_tracking" to "true")
    fun valid(key: String, value: String): Boolean = when (key) {
        "keep_awake", "battery_saver_display", "show_earnings", "haptic_geofence", "break_alert", "break_ring", "battery_tracking" -> value == "true" || value == "false"
